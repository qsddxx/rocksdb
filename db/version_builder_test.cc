  ...
  VersionBuilderTest()
      : ucmp_(BytewiseComparator()),
        ...
        vstorage_(&icmp_, ucmp_, options_.num_levels, kCompactionStyleLevel,
                  ...
                  OffpeakTimeOption(options_.daily_offpeak_time_utc),10),
        file_num_(1) {
...
TEST_F(VersionBuilderTest, ApplyFileDeletionAndAddition) {
  ...
  VersionStorageInfo new_vstorage(
      ...
      0, OffpeakTimeOption(options_.daily_offpeak_time_utc),vstorage_.GetLevelPerSegmentLevel());
...
TEST_F(VersionBuilderTest, SaveBlobFilesTo) {
  ...
  VersionStorageInfo new_vstorage_2(
      ...
      force_consistency_checks, EpochNumberRequirement::kMightMissing, nullptr,
      0, OffpeakTimeOption(options_.daily_offpeak_time_utc),new_vstorage.GetLevelPerSegmentLevel());
  ...
  VersionStorageInfo new_vstorage_3(
      ...
      EpochNumberRequirement::kMightMissing, nullptr, 0,
      OffpeakTimeOption(options_.daily_offpeak_time_utc),new_vstorage_2.GetLevelPerSegmentLevel());
